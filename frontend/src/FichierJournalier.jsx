...
const FichierJournalier = () => {
  ...
  defaultValue=""
  onChange={(e) => console.log("Puit sélectionné :", e.target.value)}
>
  <option value="" disabled>-- Choisir un puits --</option>
  <option value="Puit 1">Puit 1</option>
  <option value="Puit 2">Puit 2</option>
  <option value="Puit 3">Puit 3</option>
</select>
</div>
  ...
  placeholder=""
      ...
      <div className="flex justify-end">
        <button
          ...
          className="bg-[#EA5529] hover:bg-orange-700 text-white font-semibold text-[16px] px-10 py-3 rounded-md"
        >
          Valider
        </button>
      </div>
