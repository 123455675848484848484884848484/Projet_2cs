...
const PhasesPrevision = () => {
  ...
  return (
    <div className="min-h-screen flex bg-[#f9f9f9] px-10 pt-6 pb-12">
      {/* Colonne de gauche */}
      <div className="w-[260px] pt-16">
        <h1 className="text-[54px] font-bold text-orange-600 leading-[58px] mb-20">
          Vos<br />prévisions
        </h1>
      ...
      {/* Contenu de droite */}
      <div className="flex-1 pl-12 flex flex-col justify-between pt-14">
        ...
        <div className="flex justify-end w-full mt-auto pt-10">
          <button
