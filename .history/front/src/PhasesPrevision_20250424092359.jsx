...
const PhasesPrevision = () => {
  ...
  return (
    <div className="min-h-screen flex bg-[#f9f9f9] px-20 py-16">
      {/* Colonne de gauche */}
      <div className="w-[300px] pt-12">
        <h1 className="text-[56px] font-bold text-orange-600 leading-[60px] mb-24">
          Vos <br /> prévisions
        </h1>
        <div className="flex flex-col items-start gap-6 ml-2">
          <div className="flex items-center gap-4">
            ...
            <span className="text-orange-600 font-semibold text-xl">Phases</span>
          </div>
          <div className="h-[60px] w-[2px] bg-orange-500 ml-6" />
          <div className="flex items-center gap-4 opacity-40">
            <div className="w-12 h-12 rounded-sm bg-gray-200 flex items-center justify-center text-xl font-bold">
              2
            </div>
            <span className="text-gray-400 font-semibold text-xl">Opérations</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-between">
        <div className="bg-[#eef3f5] rounded-md shadow-md overflow-hidden max-w-5xl">
            ...
            <tbody>
              {phases.map((phase, index) => (
                <tr key={index} className="border-t border-gray-300">
                  <td className="p-4 font-medium text-gray-700">{phase.nom}</td>
                  <td className="p-4 text-gray-700">{phase.cout}</td>
                  <td className="p-4 text-gray-700">{phase.delai}</td>
                  <td className="p-4 text-gray-700">{phase.profondeur}</td>
                </tr>
              ))}
            </tbody>
          </table>
