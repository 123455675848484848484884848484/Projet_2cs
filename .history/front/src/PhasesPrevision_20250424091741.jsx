...
const PhasesPrevision = () => {
  ...
  return (
    <div className="min-h-screen flex bg-[#f9f9f9] px-16 pt-12 pb-20">
      {/* Colonne de gauche */}
      <div className="w-[280px] pt-20">
        <h1 className="text-[54px] font-bold text-orange-600 leading-[60px] mb-24">
          Vos prévisions
        </h1>
      ...
      {/* Contenu de droite */}
      <div className="flex-1 pl-16 flex flex-col justify-between pt-20">
