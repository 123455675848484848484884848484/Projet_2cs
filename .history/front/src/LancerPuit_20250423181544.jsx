    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="w-1/2 bg-[#f9f9f9] flex flex-col justify-center px-20">
        <div className="w-full max-w-[400px]">
          <h1 className="text-[48px] font-bold leading-tight text-orange-600">
            Lancer un <br /> Puit
          </h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <input
              ...
              className="w-full border-2 border-orange-500 rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-600"
              required
            />

            {/* Bouton — largeur égale à input */}
            <button
              type="submit"
              className="w-full bg-orange-600 hover:bg-orange-700 text-white text-[16px] font-semibold py-3 rounded-md transition"
            >
              Suivant
            </button>
          </form>
