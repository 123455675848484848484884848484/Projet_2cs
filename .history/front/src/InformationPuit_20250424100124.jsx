      ...
      <form onSubmit={handleSubmit} className="w-1/2 flex flex-col gap-6 max-w-[480px]">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full h-[52px] border-2 border-gray-800 rounded-md px-4 text-[16px] text-gray-900 focus:outline-none focus:border-orange-600 focus:ring-0 focus:text-orange-600"            required
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full h-[52px] border-2 border-gray-800 rounded-md px-4 text-[16px] focus:outline-none focus:ring-2 focus:ring-gray-800"
            required
          />
        </div>
