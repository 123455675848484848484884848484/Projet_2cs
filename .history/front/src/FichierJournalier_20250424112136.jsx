...
const FichierJournalier = () => {
  ...
  return (
    <div className="min-h-screen px-24 py-12 bg-[#f4f4f4]">
              ...
              <tr key={index} className="bg-white rounded-md">
                ...
                <td className="px-4 py-2 align-top">
                  <input
                    ...
                    className="w-full border border-gray-300 rounded px-2 py-1 text-gray-800 focus:outline-none focus:ring-0 focus:border-orange-600"
                  />
                </td>
                <td className="px-4 py-2 align-top">
                  <input
      ...
      <textarea
        className="w-full h-24 border border-gray-300 rounded-md p-3 mb-8 text-gray-800 focus:outline-none focus:ring-0 focus:border-orange-600"
        placeholder=""
