...
const Login = () => {
  ...
  return (
    <div className="h-screen w-screen bg-gray-100 flex">
      ...
      {/* Formulaire */}
      <div className="w-1/2 h-full flex flex-col justify-center items-center px-16 bg-white">
        <h2 className="text-3xl font-bold text-orange-500 mb-10 text-center" id="login-title">
          Connectez-vous
        </h2>

        <form className="w-full max-w-md space-y-6" onSubmit={handleSubmit} id="login-form">
          {/* Email */}
          <div>
