...
const FichierJournalier = () => {
  ...
  return (
    <div className="min-h-screen px-24 py-12 bg-[#f4f4f4]">
      ...
      <p className="text-gray-700 mb-12 max-w-[700px]">
      ...
      <label
        htmlFor="file-upload"
        className="bg-[#2f5744] text-white text-center text-[20px] font-semibold py-5 rounded-md flex justify-center items-center gap-4 mb-10 cursor-pointer hover:bg-[#254334] transition"
      >
        ...
        <input
          ...
          onChange={(e) => console.log("Fichier importé:", e.target.files[0])}
        />
      </label>

      {/* Formulaire des problèmes */}
      ...
      <button
        ...
        className="bg-[#2f5744] text-white font-semibold px-6 py-2 rounded-md mb-10 hover:bg-[#254334] transition"
      >
        + Ajouter
      </button>
      ...
      <textarea
        className="w-full h-24 border border-gray-300 rounded-md p-3 mb-10"
        placeholder="Exemple : un outil défectueux, interruption imprévue..."
